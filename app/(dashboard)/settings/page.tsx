            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateNotificationSettings({ ...settings.notifications, email: (e.target as HTMLInputElement).checked })
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateNotificationSettings({ ...settings.notifications, push: (e.target as HTMLInputElement).checked })
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) => updateNotificationSettings({ ...settings.notifications, sms: (e.target as HTMLInputElement).checked})}
                    />
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateNotificationSettings({ ...settings.notifications, accountActivity: (e.target as HTMLInputElement).checked })
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateNotificationSettings({ ...settings.notifications, newFeatures: (e.target as HTMLInputElement).checked })
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onChange={(e) =>
                        updateNotificationSettings({ ...settings.notifications, marketing: (e.target as HTMLInputElement).checked })
                      }
                    />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "real-time" | "daily" | "weekly") => updateNotificationSettings({ ...settings.notifications, frequency: value })}
                >
                  ...
                  <CardContent className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onChange={(e) =>
                          updatePrivacySettings({ ...settings.privacy, analyticsSharing: (e.target as HTMLInputElement).checked })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onChange={(e) =>
                          updatePrivacySettings({ ...settings.privacy, personalizedAds: (e.target as HTMLInputElement).checked })
                        }
                      />
                    </div>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <Select
                      ...
                      onValueChange={(value: "6-months" | "1-year" | "2-years" | "indefinite") => updatePrivacySettings({ ...settings.privacy, dataRetention: value })}
                    >
